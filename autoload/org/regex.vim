...
let org#regex#timestamp#time2 = '\v%((\d{1,2}):(\d{2})\s*)'
let org#regex#timestamp#repeater = '\v%(([.+]?\+)(\d+)(\c[hdwmy])>\s*)'
let org#regex#timestamp#repeater0 = '\v%(%([.+]?\+)\d+\c[hdwmy]>\s*)'
let org#regex#timestamp#repeater1 = '\v%((%([.+]?\+)\d+\c[hdwmy])>\s*)'
let org#regex#timestamp#delay = '\v%((--?)(\d+)(\c[hdwmy])>\s*)'
let org#regex#timestamp#delay0 = '\v%(%(--?)\d+\c[hdwmy]>\s*)'
let org#regex#timestamp#delay1 = '\v%((%(--?)\d+\c[hdwmy])>\s*)'
...
let org#regex#timestamp#repeaterdelay0 = org#regex#timestamp#repeater0 . '?' . org#regex#timestamp#delay0 . '?'
let org#regex#timestamp#repeaterdelay2 = org#regex#timestamp#repeater1 . '?' . org#regex#timestamp#delay1 . '?'

let org#regex#timestamp#timerange0 = '\v%(' . org#regex#timestamp#time0 . '%(-' . org#regex#timestamp#time0 . ')?)'
let org#regex#timestamp#timerange1 = '\v(' . org#regex#timestamp#time0 . '%(-' . org#regex#timestamp#time0 . ')?)'
let org#regex#timestamp#timerange2 = '\v%(' . org#regex#timestamp#time1 . '%(-' . org#regex#timestamp#time1 . ')?)'
let org#regex#timestamp#timerange4 = '\v%(' . org#regex#timestamp#time2 . '%(-' . org#regex#timestamp#time2 . ')?)'

let org#regex#timestamp#datetime0 = org#regex#timestamp#date0 . org#regex#timestamp#timerange0 . '?'
let org#regex#timestamp#datetime2 = org#regex#timestamp#date1 . org#regex#timestamp#timerange1 . '?'
let org#regex#timestamp#full0 = org#regex#timestamp#datetime0 . org#regex#timestamp#repeaterdelay0
let org#regex#timestamp#full4 = org#regex#timestamp#datetime2 . org#regex#timestamp#repeaterdelay2
let org#regex#timestamp#daterange0 = '\v'.o. org#regex#timestamp#full0 .c. '--' .o. org#regex#timestamp#full0 .c
let org#regex#timestamp#daterange2 = '\v'.o. '(' . org#regex#timestamp#full0 . ')' .c. '--' .o. '(' . org#regex#timestamp#full0 . ')' .c
